...
public class EmpaqueCabecera {
	...
	public Double getTotalFinalizado() {
		return totalFinalizado;
	}



	public void setTotalFinalizado(Double totalFinalizado) {
	...
	public Integer getItemsPedido() {
		return itemsPedido;
	}



	public void setItemsPedido(Integer itemsPedido) {
		this.itemsPedido = itemsPedido;
	}



	public Integer getItemsVenta() {
		return itemsVenta;
	}



	public void setItemsVenta(Integer itemsVenta) {
