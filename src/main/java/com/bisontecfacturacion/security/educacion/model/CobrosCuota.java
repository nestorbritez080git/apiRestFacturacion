...
public class CobrosCuota {
	...
	@JsonIgnoreProperties("cobrosCuota")
	@OneToMany(mappedBy="cobrosCuota")
	private List<CobrosCuotaDetalle> cobrosCuotaDetalles; 
	...
	public List<CobrosCuotaDetalle> getCobrosCuotaDetalles() {
		return cobrosCuotaDetalles;
	}


	public void setCobrosCuotaDetalles(List<CobrosCuotaDetalle> cobrosCuotaDetalles) {
		this.cobrosCuotaDetalles = cobrosCuotaDetalles;
	}
