...
public interface CuentaPagarCabeceraRepository extends JpaRepository<CuentaPagarCabecera, Serializable>{
	 ...
	 @Query(value= "select cab.id as id, pp.nombre || ' ' || pp.apellido as proveedor, pf.nombre || ' ' || pf.apellido as funcionario, cab.total, cab.pagado, cab.saldo, cab.compra_credito_id, cab.despacho_entrada_credito_id, c.fecha, pp.cedula as cedula, pp.telefono as tele from cuenta_pagar_cabecera cab inner join funcionario f on f.id=cab.funcionario_id inner join persona pf on pf.id=f.persona_id inner join proveedor p on p.id=cab.proveedor_id inner join persona pp on pp.id=p.persona_id inner join compra c on cab.compra_credito_id=c.id where cab.proveedor_id=:id order by c.fecha desc",nativeQuery = true)
	...
	public List<Object[]> getPagosProveedorCabecera(@Param("id") int id);
	 ...
	 
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where c.saldo > 0 group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getProveedorCuentaPagarAll();
	
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where (c.saldo > 0) and (c.compra_credito_id !=0) group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getCompraCreditoAll();
	
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where (c.saldo > 0) and (c.despacho_entrada_credito_id !=0) group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getDespachoEntradaCreditoAll();
	
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where c.pagado = c.total  group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getProveedorCuentaPagado();
	
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where (c.pagado = c.total) and (c.compra_credito_id !=0) group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getProveedorCompraCuentaPagado();
	
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where (c.pagado = c.total) and (c.despacho_entrada_credito_id !=0) group by persona.nombre, persona.apellido, proveedor.id , persona.cedula, persona.telefono limit 50",nativeQuery = true)
	List<Object[]> getProveedorDespEntradaCuentaPagado();
	
	///////////////////////filtro descripcion///////////////////////////
	@Query(value= "select sum(total) as totalizdos, sum(pagado) as pagado, sum(saldo) as saldoPendiente, persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono from proveedor inner join cuenta_pagar_cabecera c on c.proveedor_id = proveedor.id inner join persona on persona.id=proveedor.persona_id where (c.saldo > 0 and persona.cedula like :desc) or (c.saldo > 0 and persona.apellido like :desc) or (c.saldo > 0 and persona.nombre like :desc) group by persona.nombre, persona.apellido, proveedor.id, persona.cedula, persona.telefono limit 50",nativeQuery = true)
	...
	@Query("select  c from CuentaPagarCabecera c INNER JOIN c.compra com INNER JOIN c.tipoPlazo tp INNER JOIN c.proveedor pro INNER JOIN c.funcionario fun WHERE com.id=:id")
	public CuentaPagarCabecera buscarCuentaPagarPorCompraId(@Param("id") int id);
	
	@Query("select  c from CuentaPagarCabecera c INNER JOIN c.compra com INNER JOIN c.tipoPlazo tp INNER JOIN c.proveedor pro INNER JOIN pro.persona perProveedor INNER JOIN c.funcionario fun INNER JOIN fun.persona perFuncionario WHERE c.id=:id")
	public CuentaPagarCabecera buscarCuentaPagarPorCabeceraId(@Param("id") int id);
