...
import com.bisontecfacturacion.security.model.PagosProveedoresReferenciaCajaChica;
import com.bisontecfacturacion.security.model.Venta;
@Transactional(readOnly=true)
@Repository
public interface PagosProveedorReferenciaCajaChicaRepository extends JpaRepository<PagosProveedoresReferenciaCajaChica, Serializable> {
